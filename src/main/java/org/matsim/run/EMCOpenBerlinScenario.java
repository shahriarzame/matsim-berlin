...
@CommandLine.Command(header = ":: Open Berlin Scenario ::", version = EMCOpenBerlinScenario.VERSION, mixinStandardHelpOptions = true, showDefaultValues = true)
public class EMCOpenBerlinScenario extends MATSimApplication {
	...
	public static void main(String[] args) {
		MATSimApplication.run(EMCOpenBerlinScenario.class, args);
	}
